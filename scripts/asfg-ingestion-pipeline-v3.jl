# ==============================================================================
# SBL ASFG 3.0 Ingestion and Stage 1-6 Processing Pipeline (v3 - Unpacking Fix)
...
function extract_spline_derivatives(ws, profile, z)
    ...
    s, s_prime, _ = solve_smoothing_spline(ws, profile, sigma_unit, 1e-8)
...
println("=====================================================================================")
println("SBL ASFG 3.0 INGESTION & STAGE 4 COVARIANCE INFLATION AUDIT (v3)")
println("=====================================================================================")
