MODULE module_bl_z0hr
   ...
   ! Avoid using hardcoded SELECTED_REAL_KIND(8), which can select single precision
   ! on some compilers. For production WRF integration, import the model's native
   ! real kind (e.g., USE module_model_constants, ONLY : r8) to preserve global
   ! compilation consistency. Standalone fallback is configured below.
   ! ==========================================================================
